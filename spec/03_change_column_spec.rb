...
require_relative '../db/migrate/20191113042723_add_grade_and_birthdate_to_students'
require_relative '../db/migrate/20191113045340_change_datatype_for_birthdate'
